...
function Lobby() {
  ...
  if (isLoading || !lobby || !user) return <div>Loading</div>;
  ...
  return (
    <div>
      ...
      <h2>
        ...
        {user!.uuid === lobby.host.uuid && <i>(you)</i>}
      </h2>
      <h2>
        Guest: {lobby.guest ? lobby.guest.username : <i>none</i>}{' '}
        {user!.uuid === lobby.guest?.uuid && <i>(you)</i>}
      </h2>
